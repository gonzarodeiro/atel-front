  ...
  return (
    <div className='faster d-flex flex-column justify-content-center align-items-center vh-100 overflow-hidden'>
      <div className='container text-center'>
        <p className='font-weight-bold' style={{ fontSize: '5em', color: '#dd4b39' }}>
          Error!
        </p>
        <p className='lead pb-4'>
          La página
          <i className='font-weight-bold' style={{ color: '#dd4b39', marginLeft: '6px', marginRight: '6px' }}>
            {url.location}
          </i>
          no existe, cambió de nombre o esta temporalmente inhabilitada
        </p>
        <Link to='/'>
          <MDBBtn size='lg' className='red darken-2 animated fadeInUp shadow-none btnOption'>
