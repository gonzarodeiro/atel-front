...
const End = () => {
  return (
    <React.Fragment>
      <div data-test='row justify-content-md-center' className='d-flex justify-content-center' style={{ marginBottom: '25px', marginTop: '25px', marginLeft: '20px', marginRight: '20px' }}>
