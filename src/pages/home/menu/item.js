      ...
      <div data-test='col' className='col-md-12 col-lg-4 mb-lg-0 mb-4'>
        <div data-test='card' className='card ' style={{ borderRadius: '20px' }}>
          <div data-test='card-body' className='card-body animated zoomIn faster'>
            <h5 className='text-center' style={{ color: [colorStyle], fontSize: '18.2px', borderBottom: borderBottom, padding: '0px 0px 4px 0px', marginBottom: '14px' }}>
              {title}
            </h5>
            <label onClick={() => redirect(redirectFirstItem)} className='dark-grey-text' style={{ cursor: 'pointer' }}>
              - {firstItem}
            </label>
            <label onClick={() => redirect(redirectSecondItem)} className='dark-grey-text mb-0' style={{ cursor: 'pointer' }}>
              - {secondItem}
            </label>
          </div>
        </div>
